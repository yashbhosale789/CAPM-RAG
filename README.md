...
6. Replace the `<your-successfactors-base-url>` in package.json with the SAP SuccessFactors API url by referring the [guide](https://help.sap.com/docs/SAP_SUCCESSFACTORS_PLATFORM/d599f15995d348a1b45ba5603e2aba9b/af2b8d5437494b12be88fe374eba75b6.html).
...
- Find and remove `this.getBaseURL() +` in the files under `app/hr-approval-ui/webapp/controller`.
