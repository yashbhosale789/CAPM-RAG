    ...
    this.on('getChatRagResponse', async (req) => {
        try {
            ...
            */
            ...
            const genericRequestPrompt = 'You are a chatbot. Answer the user question based only on the context, delimited by triple backticks\n ';

            const chatRagResponse = await capllmplugin.getRagResponse   (
                ...
                genericRequestPrompt, // system prompt for the task
